...
const sendMail = () => {
    window.open(
        `mailto:emmanuelnzeakor00@yahoo.com?subject=${encodeURIComponent(
          subject
  ...
  return (
    ...
    <h2 className="text-2xl font-bold text-orange-600 mb-1 md:mb-1 lg:mb-1 xl:mb-1 text-center ">CONTACT US </h2>
    ...
    <div className="mt-5 ">
      <form action="" method="POST" onSubmit={sendMail} >
        <div className="w-full md:flex lg:flex xl:flex mt-2 mb-5">
          ...
          <div className="md:flex md:items-center lg:flex float-right xl:flex xl:float-right">
              <div className="md:w-1/3">
                  <button className="shadow bg-orange-600 text-white  py-2 px-4 mx-2 rounded-md">
                      Submit
                  </button>
              </div>
          </div>
